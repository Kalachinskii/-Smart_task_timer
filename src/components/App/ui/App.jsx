...
export function App() {
  ...
  return (
    <div className={styles['app']}>
      ...
      <TaskList tasks={items} changeCompletedTask={changeTask} changeTaskFailed={changeTask} deleteTask={deleteTask} resumeTask={changeTask} handleUpdate={updateTimeLS} setBtnState={setBtnState} btnState={btnState}/>
    </div>
  )
}